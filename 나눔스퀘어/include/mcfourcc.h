...
<tr><td>@ref FOURCC_010P</td>   <td>10</td>             <td>CHROMA420</td>          <td>24</td>                 <td>2</td>                      </tr>
...
<tr><td>@ref FOURCC_210P</td>   <td>10</td>             <td>CHROMA422</td>          <td>32</td>                 <td>2</td>                      </tr>
...
<tr><td>@ref FOURCC_PLAYUV16</td><td>16</td>            <td>CHROMA444</td>          <td>64</td>                 <td>1</td>                      </tr>
...
<tr><td>@ref FOURCC_A64L</td>   <td>16</td>             <td>CHROMA444</td>          <td>64</td>                 <td>1</td>                      </tr>
...
#ifndef FOURCC_R32C
/**@brief RGB32, packed RGB, 8 bits per component, components order: B->G->R->X, 32 bpp, clamped (min value 16, max value 235)
* @hideinitializer */
#define FOURCC_R32C MAKEFOURCC('R', '3', '2', 'C')
#endif

#ifndef FOURCC_argb
/**@brief ARGB32, packed RGB with alpha channel, 8 bits per component, components order: A->R->G->B, 32 bpp, clamped (min value 16, max value 235)
* @hideinitializer */
#define FOURCC_argb MAKEFOURCC('a', 'r', 'g', 'b')
#endif

#ifndef FOURCC_R24C
/**@brief RGB24, packed RGB, 8 bits per component, components order: B->G->R, 24 bpp, clamped (min value 16, max value 235)
* @hideinitializer */
#define FOURCC_R24C MAKEFOURCC('R', '2', '4', 'C')
#endif

#ifndef FOURCC_YuYv
/**@brief YUYV, packed YUV, 4:2:2, clamped luma and chroma components, 16 bpp (as in ITU601)
* @hideinitializer */
#define FOURCC_YuYv MAKEFOURCC('Y', 'u', 'Y', 'v')
#endif

#ifndef FOURCC_UyVy
/**@brief UYVY, packed YUV, 4:2:2, clamped luma and chroma components, 16 bpp (as in ITU601)
* @hideinitializer */
#define FOURCC_UyVy MAKEFOURCC('U', 'y', 'V', 'y')
#endif
...
#ifndef FOURCC_010P
/**@brief Intel P010, planar YUV, 4:2:0, 16 bits per component but only low 10 bits are significant, 24 bpp
* @hideinitializer */
#define FOURCC_010P MAKEFOURCC('0', '1', '0', 'P')
#endif
...
#ifndef FOURCC_210P
/**@brief Intel P210, planar YUV, 4:2:2, 16 bits per component but only low 10 bits are significant, 32 bpp
* @hideinitializer */
#define FOURCC_210P MAKEFOURCC('2', '1', '0', 'P')
#endif
...
#ifndef FOURCC_b64a
/**@brief Packed ARGB 16-bit, big endian, components order: A->R->G->B, 64 bpp
* @hideinitializer */
...
* @hideinitializer */
#define FOURCC_A64L MAKEFOURCC('A', '6', '4', 'L')
#endif
...
#ifndef FOURCC_PLAYUV16
/**@brief Planar AYUV, 4:4:4:4, 16 bits per component, planes order: A->Y->U->V, 64 bpp
* @hideinitializer */
#define FOURCC_PLAYUV16 MAKEFOURCC('P', 'A', 'Y', 0x10)
#endif
