...
typedef enum mcmediatypes
{
    ...
    mctAV1 = 41,                     ///< AV1 video stream type
...
{ 
    ...
    uint8_t  compressorname_len;        ///< Number of bytes to be displayed in @compressorname
    char     compressorname[31];        ///< Informal compressor name. Number of bytes to be displayed is @compressorname_len
